...
The tldraw [editor](/docs/editor) has a runtime JavaScript API. Everything that can happen in tldraw can be done programmatically through the [`Editor`](/reference/editor/Editor) instance.
...
The Editor is tldraw's main interface for controlling the canvas. Be sure to check out the [`Editor`](/reference/editor/Editor) API documentation for more information on what you can do with it, as well as our [guide on using the editor](/docs/editor).
